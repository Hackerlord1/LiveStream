...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Email partnership@inbound.bravestream.live with details about your content.',
  },
  {
...
export default function ContactPage() {
  ...
  const supportEmail = 'support@inbound.bravestream.live';
  ...
  const contactItems = [
    {
      icon: <FaEnvelope className="text-red-600 shrink-0" />,
      label: 'Email',
      value: supportEmail,
      copyable: true,
    },
    {
      icon: <FaPhone className="text-red-600 shrink-0" />,
      label: 'Phone',
      value: '+254 791 220 335',
      copyable: false,
    },
    {
      icon: <FaClock className="text-red-600 shrink-0" />,
      label: 'Response Time',
      value: '~15 minutes',
      copyable: false,
    },
                ...
                {item.copyable ? (
                  <div className="flex items-start gap-2 min-w-0">
                    <a
                      ...
                      className="text-sm font-medium break-all min-w-0 hover:underline"
                      style={{ color: 'var(--text-primary)' }}
                      title={item.value}
                    >
                      {item.value}
                    ...
                    >
                      {copiedEmail ? (
                        ...
                        <FaCopy className="w-3.5 h-3.5 text-red-600" />
                      )}
                    </button>
                  </div>
                ) : (
        ...
        <section className="mb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-red-600 hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
            >
